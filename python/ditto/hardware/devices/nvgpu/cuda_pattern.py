...
scalar_patterns = {
    "scalar_fp16": pattern.scalar_pattern("float16", "", name="scalar_fp16"),
    "scalar_fp32": pattern.scalar_pattern("float32", "", name="scalar_fp32"),
    "scalar_int32": pattern.scalar_pattern("int32", "", name="scalar_int32"),
    "scalar_int8": pattern.scalar_pattern("int8", "", name="scalar_int8"),
}
...
wmma_sm70_patterns = {
    ...
    "accumulator_16x16_row_major_fp16": pattern.matrix_pattern(
        ...
        name="accumulator_16x16_row_major_fp16",
    ),
    "accumulator_32x8_row_major_fp16": pattern.matrix_pattern(
        ...
        8,
        "accumulator::row_major",
        name="accumulator_32x8_row_major_fp16",
    ),
    "accumulator_8x32_row_major_fp16": pattern.matrix_pattern(
        ...
        32,
        "accumulator::row_major",
        name="accumulator_8x32_row_major_fp16",
    ),
    # fp32 accumulator
    "accumulator_16x16_row_major_fp32": pattern.matrix_pattern(
        ...
        16,
        "accumulator::row_major",
        name="accumulator_16x16_row_major_fp32",
    ),
    "accumulator_32x8_row_major_fp32": pattern.matrix_pattern(
        ...
        8,
        "accumulator::row_major",
        name="accumulator_32x8_row_major_fp32",
    ),
    "accumulator_8x32_row_major_fp32": pattern.matrix_pattern(
        ...
        32,
        "accumulator::row_major",
        name="accumulator_8x32_row_major_fp32",
    ),
}
...
wmma_sm75_patterns = {
    **wmma_sm70_patterns,
    ...
    "accumulator_16x16_row_major_int32": pattern.matrix_pattern(
        ...
        16,
        "accumulator::row_major",
        name="accumulator_16x16_row_major_int32",
    ),
    "accumulator_32x8_row_major_int32": pattern.matrix_pattern(
        ...
        8,
        "accumulator::row_major",
        name="accumulator_32x8_row_major_int32",
    ),
    "accumulator_8x32_row_major_int32": pattern.matrix_pattern(
        ...
        32,
        "accumulator::row_major",
        name="accumulator_8x32_row_major_int32",
    ),
...
wmma_sm80_patterns = {
    **wmma_sm75_patterns,
    ...
    "matrix_a_16x16_row_major_bf16": pattern.matrix_pattern(
        ...
        16,
        "matrix_a::row_major",
        name="matrix_a_16x16_row_major_bf16",
    ),
    "matrix_a_8x16_row_major_bf16": pattern.matrix_pattern(
        ...
        16,
        "matrix_a::row_major",
        name="matrix_a_8x16_row_major_bf16",
    ),
    "matrix_a_32x16_row_major_bf16": pattern.matrix_pattern(
        ...
        16,
        "matrix_a::row_major",
        name="matrix_a_32x16_row_major_bf16",
    ),
    # bf16 matrix b
    "matrix_b_16x16_row_major_bf16": pattern.matrix_pattern(
        ...
        16,
        "matrix_b::row_major",
        name="matrix_b_16x16_row_major_bf16",
    ),
    "matrix_b_16x8_row_major_bf16": pattern.matrix_pattern(
        ...
        8,
        "matrix_b::row_major",
        name="matrix_b_16x8_row_major_bf16",
    ),
    "matrix_b_16x32_row_major_bf16": pattern.matrix_pattern(
        ...
        32,
        "matrix_b::row_major",
        name="matrix_b_16x32_row_major_bf16",
    ),
    # tf32 matrix a
    "matrix_a_16x8_row_major_tf32": pattern.matrix_pattern(
        ...
        8,
        "matrix_a::row_major",
        name="matrix_a_16x16_row_major_tf32",
    ),
    # tf32 matrix b
    "matrix_b_8x16_row_major_tf32": pattern.matrix_pattern(
        ...
        16,
        "matrix_b::row_major",
        name="matrix_b_8x16_row_major_tf32",
    ),
    # fp64 matrix a
