...
def main(B, M, N, K, L, dtype, only_once=False):
    ...
    if only_once:
        ...
        output = torch_bmm_bmm_cuda(*inputs_torch)
        cost = -1
    else:
        inputs_torch = [
        ...
        for i in range(repeat):
            output = torch_bmm_bmm_cuda(*inputs_torch[i])
...
if __name__ == "__main__":
    ...
    for ss in shapes[args.begin : args.begin + args.num]:
        B, M, N, K, L = ss
        cost = main(B, M, N, K, K, args.dtype, args.only_once)
