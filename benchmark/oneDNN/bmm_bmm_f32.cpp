...
void matmul_example(dnnl::engine::kind engine_kind) {
    ...
    // post_ops matmul1_ops;
    // matmul1_ops.append_eltwise(scale, algorithm::eltwise_relu, alpha, beta);
    primitive_attr matmul1_attr;
    // matmul1_attr.set_post_ops(matmul1_ops);
    ...
    for (int j = 0; j < times; ++j) {
        ...
        double tmp = (double)(std::chrono::duration_cast<
