...
def relay_conv_relu_conv(
    ...
    relu = relay.nn.relu(data = D)
    F = relay.nn.conv2d(relu, C, strides=(stride1, stride1), padding=(padding1, padding1), dilation=(1, 1), groups=1, channels=C2, kernel_size=(R2, S2), data_layout='NCHW', kernel_layout='OIHW', out_layout='', out_dtype='')
...
example_text = """
 example:
    python conv_relu_conv_relay.py --dtype float32 --begin 0 --num 1
"""
