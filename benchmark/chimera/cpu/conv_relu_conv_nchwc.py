...
def conv_relu_conv_nchwc(
    ...
    (Img,Weight1,Weight2,conv1_frag, Weight1_fact, relu1, Weight2_fact, pad2_fact, conv2_frag) # , pad1, pad1_fact)#conv2_frag_rfact) #pad1, pad1_fact
...
def test_double_conv(
    ...
    ins, outs, _ = conv_relu_conv_nchwc(*shape)
...
def testSchedule(shape, server, fusionConfig):
    ...
    func = tvm.build(sch, tensors, name="conv_relu_conv")
    ctx = tvm.cpu()
    tensors_np = [
...
example_text = "python conv_relu_conv_nchw.py --server scccc --begin 0 --num 1"
...
if __name__ == "__main__":
    ...
    for ss in shapes[args.begin: args.begin + args.num]:
        ...
        with open(f"{args.output}/conv_relu_conv_nchwc-chimera.pkl", "wb") as f:
            pkl.dump(costs, f)
