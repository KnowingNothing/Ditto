...
if __name__ == "__main__":
    ...
    input_ids = torch.zeros([batch, seq_len, dim], dtype=torch.float32)
    ...
    if profile_bmm:
        ...
        print("Total best Transformer latency", min(time_record), "ms")
        print("Total average Transformer latency", np.mean(time_record), "ms")
        print("Totak  median Transformer latency", np.median(time_record), "ms")
    else:
