...
//     bool operator == (const Iterator & a, const Iterator & b) {return a.searchSpace == b.searchSpace; };
//     bool operator != (const Iterator & a, const Iterator & b) {return a.searchSpace != b.searchSpace; };
// };
...
public:
    ...
    TVM_DEFINE_MUTABLE_OBJECT_REF_METHODS(TilingSpace, SearchSpace, TilingSpaceNode);
...
public:
    ...
    TVM_DEFINE_MUTABLE_OBJECT_REF_METHODS(AttachSpace, SearchSpace, AttachSpaceNode);
...
public:
    ...
    TVM_DEFINE_MUTABLE_OBJECT_REF_METHODS(PermuteSpace, SearchSpace, PermuteSpaceNode);
...
public:
    TVM_DLL FusionSpace(PermuteSpace firstOpPermute, PermuteSpace secondOpPermute,\
                        ...
                        AttachSpace attach);
    TVM_DEFINE_MUTABLE_OBJECT_REF_METHODS(FusionSpace, SearchSpace, FusionSpaceNode);
    TVM_DEFINE_OBJECT_REF_COW_METHOD(FusionSpaceNode);
  };
  inline FusionItem buildFusionItem(Array<IntImm> firstOpTiling, Array<IntImm> secondOpTiling,\
