...
namespace ditto
{
  ...
  namespace auto_tensorize
  {
    ...
    struct FusionInfo
    {
      ...
      Map<tir::Var, IntImm> upper_bounds_for_lower_cache_level;
      Map<tir::Var, IntImm> lower_bounds_for_upper_cache_level;
      std::vector<std::pair<int, int>> op1InnerIvs;
      std::vector<std::pair<int, int>> op2InnerIvs;
