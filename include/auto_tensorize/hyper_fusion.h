...
namespace ditto
{
  ...
  namespace auto_tensorize
  {
    ...
    public:
      TVM_DLL
      FusionContext(SerialFusionState sfs, std::vector<CPUTensorizeParam> schParams, Layer layer,
                    TensorizeHyperFusionState state, tir::StringImm code,
                    String path, hardware::HardwareParam hw_param, int bytePerEle);
