...
public:
    ...
    static constexpr const char * _type_key = \
        "ditto.auto_tensorize.IterVar";
    TVM_DECLARE_FINAL_OBJECT_INFO(IterVarNode, Object);
};

class IterVar: public ObjectRef{
public:
    TVM_DLL IterVar(int idx, FACTOR ext, IV_Type iv_type, tvm::tir::Var name, tvm::tir::Var originVar);
...
public:
    ...
    void VisitAttrs(AttrVisitor *v){
        ...
        v->Visit("splitRelatoins", &splitRelations);
    }
    /*!
    ...
    */
     ...
     *  \param permutation: new order of the iterators, new ith object contains permutation[i] 
     */
    ...
    /*!
     * \brief set parameters in one run
     */
    void setSchedule(FusionItem fusionItem);
    /*!
     * \brief synchronize the schedule logs
     */
    void synchronize();
...
public:
    TVM_DLL IterGraph(  Array<IterVar> firstOpIters,\
                        Array<IterVar> secondOpIters,\
