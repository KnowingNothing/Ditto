...
if(NOT DEFINED ENV{VTA_HW_PATH})
  set(VTA_HW_PATH ${CMAKE_CURRENT_SOURCE_DIR}/3rdparty/tvm/3rdparty/vta-hw)
else()
...
elseif(PYTHON)
  ...
  if(USE_VTA_FSIM)
    ...
    file(GLOB FSIM_RUNTIME_SRCS 3rdparty/tvm/vta/runtime/*.cc)
  ...
  if(USE_VTA_TSIM)
    ...
    file(GLOB TSIM_RUNTIME_SRCS 3rdparty/tvm/vta/runtime/*.cc)
  ...
  if(USE_VTA_FPGA)
    file(GLOB FSIM_RUNTIME_SRCS ${VTA_HW_PATH}/src/*.cc)
    file(GLOB FPGA_RUNTIME_SRCS 3rdparty/tvm/vta/runtime/*.cc)
