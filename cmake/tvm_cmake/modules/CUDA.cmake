...
if(USE_CUDA)
  ...
  file(GLOB RUNTIME_CUDA_SRCS 3rdparty/tvm/src/runtime/cuda/*.cc)
  list(APPEND RUNTIME_SRCS ${RUNTIME_CUDA_SRCS})
  list(APPEND COMPILER_SRCS 3rdparty/tvm/src/target/opt/build_cuda_on.cc)
  ...
  if(USE_CUDNN)
    ...
    file(GLOB CONTRIB_CUDNN_SRCS 3rdparty/tvm/src/runtime/contrib/cudnn/*.cc)
  ...
  if(USE_CUBLAS)
    ...
    file(GLOB CONTRIB_CUBLAS_SRCS 3rdparty/tvm/src/runtime/contrib/cublas/*.cc)
  ...
  if(USE_THRUST)
    ...
    file(GLOB CONTRIB_THRUST_SRC 3rdparty/tvm/src/runtime/contrib/thrust/*.cu)
  ...
  if(USE_GRAPH_EXECUTOR_CUDA_GRAPH)
    ...
    file(GLOB RUNTIME_CUDA_GRAPH_SRCS 3rdparty/tvm/src/runtime/graph_executor/cuda_graph/*.cc)
    list(APPEND RUNTIME_SRCS ${RUNTIME_CUDA_GRAPH_SRCS})
  endif()
else(USE_CUDA)
  list(APPEND COMPILER_SRCS 3rdparty/tvm/src/target/opt/build_cuda_off.cc)
endif(USE_CUDA)
