...
if(USE_ROCM)
  ...
  file(GLOB RUNTIME_ROCM_SRCS 3rdparty/tvm/src/runtime/rocm/*.cc)
  ...
  if(USE_MIOPEN)
    ...
    file(GLOB MIOPEN_CONTRIB_SRCS 3rdparty/tvm/src/runtime/contrib/miopen/*.cc)
  ...
  if(USE_ROCBLAS)
    ...
    file(GLOB ROCBLAS_CONTRIB_SRCS 3rdparty/tvm/src/runtime/contrib/rocblas/*.cc)
  ...
  if(USE_THRUST)
    ...
    set_source_files_properties(3rdparty/tvm/src/runtime/contrib/thrust/thrust.cu PROPERTIES LANGUAGE CXX)
    list(APPEND RUNTIME_SRCS 3rdparty/tvm/src/runtime/contrib/thrust/thrust.cu)
    list(APPEND TVM_RUNTIME_LINKER_LIBS roc::rocthrust)
  endif(USE_THRUST)

else(USE_ROCM)
  list(APPEND COMPILER_SRCS 3rdparty/tvm/src/target/opt/build_rocm_off.cc)
endif(USE_ROCM)
