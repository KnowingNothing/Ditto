...
include(cmake/tvm_cmake/modules/HexagonSDK.cmake)
...
if(USE_HEXAGON_DEVICE STREQUAL "OFF")
  list(APPEND COMPILER_SRCS 3rdparty/tvm/src/target/opt/build_hexagon_off.cc)
  return()
...
if(USE_HEXAGON_DEVICE STREQUAL "${PICK_SIM}")
  ...
  file(GLOB RUNTIME_HEXAGON_SIM_SRCS 3rdparty/tvm/src/runtime/hexagon/sim/*.cc)
  ...
  ExternalProject_Add(sim_dev
    SOURCE_DIR "3rdparty/tvm/src/runtime/hexagon/sim/driver"
    CMAKE_ARGS
...
elseif(USE_HEXAGON_DEVICE STREQUAL "${PICK_HW}")
  find_hexagon_sdk_root("${USE_HEXAGON_SDK}" "${USE_HEXAGON_ARCH}")
  find_hexagon_toolchain()
  file(GLOB RUNTIME_HEXAGON_DEVICE_SRCS 3rdparty/tvm/src/runtime/hexagon/target/*.cc)
...
file(GLOB RUNTIME_HEXAGON_SRCS 3rdparty/tvm/src/runtime/hexagon/*.cc)
