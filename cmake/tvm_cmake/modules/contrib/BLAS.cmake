...
if(USE_BLAS STREQUAL "openblas")
  ...
  list(APPEND RUNTIME_SRCS 3rdparty/tvm/src/runtime/contrib/cblas/cblas.cc)
...
if(USE_MKL OR USE_MKL_PATH)
  ...
  list(APPEND RUNTIME_SRCS 3rdparty/tvm/src/runtime/contrib/cblas/mkl.cc)
...
if(IS_DIRECTORY ${USE_MKLDNN})
  ...
  if (MKLDNN_LIBRARY STREQUAL "MKLDNN_LIBRARY-NOTFOUND")
    ...
    list(APPEND RUNTIME_SRCS 3rdparty/tvm/src/runtime/contrib/cblas/mkldnn.cc)
