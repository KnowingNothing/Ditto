...
if(NOT USE_ETHOSN STREQUAL "OFF")
  ...
  if(NOT ETHOSN_FOUND)
    ...
    file(GLOB ETHOSN_RUNTIME_CONTRIB_SRC
      CONFIGURE_DEPENDS 3rdparty/tvm/src/runtime/contrib/ethosn/ethosn_runtime.cc
      CONFIGURE_DEPENDS 3rdparty/tvm/src/runtime/contrib/ethosn/ethosn_device.cc)
    list(APPEND RUNTIME_SRCS ${ETHOSN_RUNTIME_CONTRIB_SRC})

    file(GLOB COMPILER_ETHOSN_SRCS
      CONFIGURE_DEPENDS 3rdparty/tvm/src/relay/backend/contrib/ethosn/*)
