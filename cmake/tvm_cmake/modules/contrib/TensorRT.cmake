...
if(USE_TENSORRT_CODEGEN)
    ...
    file(GLOB COMPILER_TENSORRT_SRCS 3rdparty/tvm/src/relay/backend/contrib/tensorrt/*.cc)
    set_source_files_properties(${COMPILER_TENSORRT_SRCS} PROPERTIES COMPILE_FLAGS "-Wno-deprecated-declarations")
    file(GLOB RUNTIME_TENSORRT_SRCS 3rdparty/tvm/src/runtime/contrib/tensorrt/tensorrt_runtime.cc)
...
if(USE_TENSORRT_RUNTIME)
    ...
    # TRT runtime sources
    file(GLOB RUNTIME_TENSORRT_SRCS 3rdparty/tvm/src/runtime/contrib/tensorrt/*.cc)
    set_source_files_properties(${RUNTIME_TENSORRT_SRCS} PROPERTIES COMPILE_FLAGS "-Wno-deprecated-declarations")
