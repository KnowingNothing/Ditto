...
if(USE_METAL)
  ...
  file(GLOB RUNTIME_METAL_SRCS 3rdparty/tvm/src/runtime/metal/*.mm)
  list(APPEND TVM_RUNTIME_LINKER_LIBS ${METAL_LIB} ${FOUNDATION_LIB})
  list(APPEND RUNTIME_SRCS ${RUNTIME_METAL_SRCS})

  if(USE_MPS)
    file(GLOB MPS_CONTRIB_SRC 3rdparty/tvm/src/runtime/contrib/mps/*.mm)
  ...
  list(APPEND COMPILER_SRCS 3rdparty/tvm/src/target/opt/build_metal_off.cc)
endif(USE_METAL)
