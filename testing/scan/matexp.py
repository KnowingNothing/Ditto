...
def rnn_matexp():
    ...
    def check_device(target):
        ...
        with open(f"trace_matexp_{PERSIST_KERNEL}_kernel.log", "w") as fout:
            print(f.imported_modules[0].get_source(), file=fout)    
        ...
        if not SKIP_CHECK:
            ...
            testing.assert_allclose(res_cuda, res_cmp, rtol=1e-3)
