...
FusionSpace::FusionSpace(PermuteSpace firstOpPermute,
                         PermuteSpace secondOpPermute,
  ...
  //             << " " << firstOpTiling->cardinal << " " <<
  //             secondOpTiling->cardinal
...
Item FusionSpaceNode::idxToItem(size_t idx) const {
  ...
  secondOpTilingItem = Downcast<TilingItem, Item>(
      secondOpTiling->idxToItem(idx % secondOpTiling->cardinal));
  ...
  FusionItem item =
      FusionItem(firstOpTilingItem, secondOpTilingItem, firstOpPermuteItem,
...
TVM_REGISTER_GLOBAL("ditto.auto_tensorize.setSecondOpPermuteMandatory")
    .set_body_method<FusionSpace>(
        &FusionSpaceNode::setSecondOpPermuteMandatory);
