...
namespace ditto{
    namespace auto_tensorize{
        ...
        double FusionResultNode::getArithmeticIntensity() const{
            ...
            return (op1.workLoad + op2.workLoad) / double(op1.dataMovementVolume + op2.dataMovementVolume);
        }
        StaticAnalysis::StaticAnalysis(IterGraph ig, hardware::HardwareParam hw_param, String dtype){
