...
size_t InferTensorizeRegion(const ComputeOpNode* self, const HybridStage& stage,
  ...
  hybrid::PassUpDomain(stage, dom_map, &up_state);
...
void VerifyTensorizeLoopNest(const ComputeOpNode* self, const HybridStage& stage,
...
class TensorIntrinMatcher final : public StmtExprMutator {
 public:
  ...
  void Init(const ComputeOpNode* self, const HybridStage& stage,
            const std::unordered_map<IterVar, Range>& dom_map,
...
Array<PrimExpr> MatchTensorizeBody(const ComputeOpNode* self, const HybridStage& stage,
                                   const std::unordered_map<IterVar, Range>& dom_map,
                                   const std::unordered_map<IterVar, Range>& out_dom,
...
void VerifyTensorizeBody(const ComputeOpNode* self, const HybridStage& stage,
